...
const actionsFrecuentQuestions = {
    ...
    'frequent.question.auditoria.action': {
        ...
        linkPDF: 'https://firebasestorage.googleapis.com/v0/b/auditbot-c41e4.appspot.com/o/frecuent_requests%2F%C2%BFQue%CC%81%20es%20Auditori%CC%81a%20Interna_.pdf?alt=media&token=99cb0ce1-abab-4792-b071-4932e84c6768'
    },
    // 1: CONDICIONES PARA UNA PRORROGA
    'frequent.question.prorroga.action': {
        intentName: 'Frecuente - Condiciones para una Prórroga Intent',
        cardTitle: 'Prórrogas',
        linkPDF: 'https://firebasestorage.googleapis.com/v0/b/auditbot-c41e4.appspot.com/o/frecuent_requests%2FCondiciones%20para%20una%20Pro%CC%81rroga.pdf?alt=media&token=53e21953-0410-49f9-9b83-f24000bdc66d'
    }
};


module.exports = {
    actionsFrecuentQuestions
};